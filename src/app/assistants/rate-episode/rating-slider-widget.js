 ...
 * 
 **/
Widget.Episode.RatingSlider = Class.create(BaseWidget, {
	...
	createAddEpisodeRatingListener: function(userRating) {
		...
		this.createActionRequest("AddEpisodeRating", parameters, null, new AddEpisodeRatingResponseHandler(this.assistant, this, parameters));
	},
